...
func (g *GeneratedService) A() {
	err := g.run(context.Background(), "A", func(_ context.Context) error {
		g.delegate.A()
		return nil
	})
	if err != nil {
...
func (g *GeneratedService) B(ctx context.Context) {
	err := g.run(ctx, "B", func(ctx context.Context) error {
		g.delegate.B(ctx)
		return nil
	})
	if err != nil {
...
func (g *GeneratedService) C(ctx context.Context, arg1 int, arg2 *int32, arg3 *unresilient.User) {
	err := g.run(ctx, "C", func(ctx context.Context) error {
